...
function increment() {
    if(counter<0){
        ...
        texterror.innerHTML = "<span style='color:crimson;'>Error : Cannot go below 0 </span>"
...
function decrement() {
    if(counter<=-1){
        console.log('Error:cannot go  below 0');
        texterror.innerHTML = "<span style='color:crimson;border:none;'>Error : Cannot go below 0 </span>"
